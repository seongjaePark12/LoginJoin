...
<body>
	...
	<div class="container">
		...
		<table class="table">
			...
			<tr>
				<td>탈퇴여부 : 
					<c:if test="${vo.userDel ne 'NO'}"><a href="javascript:memberReset(${vo.idx})">탈퇴신청</a></c:if> 
			...
			<tr>
				<td>등급 : 
					<c:choose>
					<c:when test="${vo.level == 1}"><c:set var="level" value="준회원"/></c:when>
		...
		<hr/>
		<a href="${ctp}/adMemberList.ad">돌아가기</a>
	</div>
	<br/>	
</body>
</html>