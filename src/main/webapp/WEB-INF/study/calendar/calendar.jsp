...
<jsp:include page="/include/nav.jsp"/>
	...
	<div class="container">
		<font size="5">달력연습</font>&nbsp;&nbsp;
			...
			<a href="${ctp}/calendar.st?yy=<%=prevYear%>&mm=<%=prevMonth%>" title="이전월">◀</a>
			(<%=yy %>년 <%=mm+1%>월)
			<a href="${ctp}/calendar.st?yy=<%=nextYear%>&mm=<%=nextMonth%>" title="다음년도">▶</a>
			<a href="${ctp}/calendar.st?yy=<%=nextYear+1%>&mm=<%=mm%>" title="다음월">▷▷</a>
			&nbsp;&nbsp;
