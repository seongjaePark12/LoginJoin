...
-- irum필드를 name필드로 수정하시오? 길이는 가변문자형(20). null 불허
...
select name as '성명', gender '성별', jikwi, address from insarok;
...
select * from insarok where buser = '영업과' and gender ='남자'and address = '인천';
